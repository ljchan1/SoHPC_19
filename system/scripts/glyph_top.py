...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      slice1.SliceType.Origin = [-0.5999999046325684, -0.40000000363215804, 0.2]
      ...
      coprocessor.RegisterWriter(glyphWriter1, filename='glyph_top1_%t.vtm', freq=2)
      ...
      # init the 'Plane' selected for 'SliceType'
      slice2.SliceType.Origin = [-0.5999999046325684, -0.40000000363215804, -0.2]
      slice2.SliceType.Normal = [0.0, 0.0, 1.0]

      # create a new 'Glyph'
      glyph2 = Glyph(Input=slice2, GlyphType='Arrow')
      glyph2.Scalars = ['POINTS', 'p']
      glyph2.Vectors = ['POINTS', 'U']
      glyph2.ScaleFactor = 0.5
      glyph2.MaximumNumberOfSamplePoints = 4000
      glyph2.GlyphTransform = 'Transform2'

      # init the 'Arrow' selected for 'GlyphType'
      glyph2.GlyphType.TipRadius = 0.05
      glyph2.GlyphType.TipLength = 0.1
      glyph2.GlyphType.ShaftRadius = 0.008

      glyphWriter2 = servermanager.writers.XMLMultiBlockDataWriter(Input=glyph2)
      coprocessor.RegisterWriter(glyphWriter2, filename='glyph_top2_%t.vtm', freq=2)
