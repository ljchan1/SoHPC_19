...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      # create a new 'Glyph'
      glyph1 = Glyph(Input=region, GlyphType='Arrow')
      glyph1.Scalars = ['POINTS', 'p']
      glyph1.Vectors = ['POINTS', 'U']
      glyph1.ScaleFactor = 0.5
      glyph1.MaximumNumberOfSamplePoints = 3000
      glyph1.Stride = 100
      ...
      coprocessor.RegisterWriter(glyphWriter1, filename='glyph_3D_%t.vtm', freq=2)
