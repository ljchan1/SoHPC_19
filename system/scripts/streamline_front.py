...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      streamTracer1.SeedType.Point1 = [-5.2, -0.4, -2.1]
      streamTracer1.SeedType.Point2 = [-5.2, -0.4, 2.1]
      ...
      coprocessor.RegisterWriter(tubeWriter1, filename='streamline_front_%t.vtm', freq=2)
